    ...
    public partial class TavilyClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                global::Tavily.Response9? __value_429 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_429 = global::Tavily.Response9.FromJson(__content_429, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_429 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_429 = await global::Tavily.Response9.FromJsonStreamAsync(__contentStream_429, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_401 = await global::Tavily.Response10.FromJsonStreamAsync(__contentStream_401, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                global::Tavily.Response11? __value_400 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = global::Tavily.Response11.FromJson(__content_400, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_400 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = await global::Tavily.Response11.FromJsonStreamAsync(__contentStream_400, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 432)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_432 = await global::Tavily.Response12.FromJsonStreamAsync(__contentStream_432, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 433)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_433 = await global::Tavily.Response13.FromJsonStreamAsync(__contentStream_433, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_500 = await global::Tavily.Response14.FromJsonStreamAsync(__contentStream_500, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
