...
namespace Tavily
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Tavily.AutoSDKRetryOptions Retry { get; set; } = new global::Tavily.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Tavily.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Tavily.IAutoSDKHook>();
        ...
        public global::Tavily.AutoSDKClientOptions AddHook(
            global::Tavily.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Tavily.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Tavily.AutoSDKClientOptions UseAuthorizationProvider(
            global::Tavily.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Tavily.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Tavily.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Tavily.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Tavily.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Tavily.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Tavily.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Tavily.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Tavily.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Tavily.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Tavily.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Tavily.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Tavily.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Tavily.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Tavily.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Tavily.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Tavily.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Tavily.AutoSDKClientOptions clientOptions,
            global::Tavily.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Tavily.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Tavily.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Tavily.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Tavily.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Tavily.IAutoSDKHook, global::Tavily.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Tavily.AutoSDKHookContext context)
        {
