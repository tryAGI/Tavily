...
namespace Tavily
{
    public partial interface ITavilyClient
    {
        ...
        /// print(response)
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Tavily.MapResponse> MapAsync(
        ...
        /// print(response)
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Tavily.AutoSDKHttpResponse<global::Tavily.MapResponse>> MapAsResponseAsync(
