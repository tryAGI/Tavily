...
namespace Tavily
{
    public partial class TavilyClient
    {
        ...
        private static readonly global::Tavily.EndPointSecurityRequirement s_SearchSecurityRequirement0 =
        ...
        private static readonly global::Tavily.EndPointSecurityRequirement[] s_SearchSecurityRequirements =
            new global::Tavily.EndPointSecurityRequirement[]
        ...
        /// print(response)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Tavily.AutoSDKHttpResponse<global::Tavily.SearchResponse>> SearchAsResponseAsync(
            ...
            try
            {
                ...
                else
                {
                    await global::Tavily.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Request validation failed. The detail array identifies invalid fields.
                            if ((int)__response.StatusCode == 422)
                            {
                                string? __content_422 = null;
                                global::System.Exception? __exception_422 = null;
                                global::Tavily.ValidationError? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::Tavily.ValidationError.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Tavily.ApiException<global::Tavily.ValidationError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Tavily.SearchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Tavily.AutoSDKHttpResponse<global::Tavily.SearchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Tavily.SearchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Tavily.SearchResponse> SearchAsync(
            ...
            global::Tavily.SearchRequestTopic? topic = default,
            global::Tavily.SearchRequestTimeRange? timeRange = default,
            string? startDate = default,
            string? endDate = default,
            bool? includePublishedDate = default,
            bool? filterByPublishedDate = default,
            global::Tavily.OneOf<bool?, global::Tavily.SearchRequestIncludeAnswer?>? includeAnswer = default,
            global::Tavily.OneOf<bool?, global::Tavily.SearchRequestIncludeRawContent?>? includeRawContent = default,
            ...
            global::Tavily.SearchRequestIncludeDomainsMode? includeDomainsMode = default,
            global::Tavily.SearchRequestCountry? country = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Tavily.SearchRequest
            {
                ...
                FilterByPublishedDate = filterByPublishedDate,
