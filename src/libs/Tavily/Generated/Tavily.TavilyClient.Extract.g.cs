...
namespace Tavily
{
    public partial class TavilyClient
    {
        ...
        private static readonly global::Tavily.EndPointSecurityRequirement s_ExtractSecurityRequirement0 =
        ...
        private static readonly global::Tavily.EndPointSecurityRequirement[] s_ExtractSecurityRequirements =
            new global::Tavily.EndPointSecurityRequirement[]
            {                s_ExtractSecurityRequirement0,
            };
        partial void PrepareExtractArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tavily.ExtractRequest request);
        partial void PrepareExtractRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tavily.ExtractRequest request);
        partial void ProcessExtractResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExtractResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// print(response)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Tavily.ExtractResponse> ExtractAsync(

            global::Tavily.ExtractRequest request,
            global::Tavily.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ExtractAsResponseAsync(
        ...
        /// print(response)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Tavily.AutoSDKHttpResponse<global::Tavily.ExtractResponse>> ExtractAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Tavily.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExtractSecurityRequirements,
                operationName: "ExtractAsync");
            ...
            try
            {
                ...
                else
                {
                    await global::Tavily.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad Request. More than 20 URLs, an empty URL list, or no URLs passing validation are rejected. When all URLs fail validation, detail.failed_results describes the individual failures.
                            if ((int)__response.StatusCode == 400)
                            {
                                string? __content_400 = null;
                                global::System.Exception? __exception_400 = null;
                                global::Tavily.AllOf<global::Tavily.ApiError, global::Tavily.ExtractResponse3>? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Tavily.AllOf<global::Tavily.ApiError, global::Tavily.ExtractResponse3>.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Tavily.ApiException<global::Tavily.AllOf<global::Tavily.ApiError, global::Tavily.ExtractResponse3>?>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 432)
                            {
                                ...
                                global::Tavily.ApiError? __value_432 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_432 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_432 = global::Tavily.ApiError.FromJson(__content_432, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_432 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if ((int)__response.StatusCode == 433)
                            {
                                ...
                                global::Tavily.ApiError? __value_433 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_433 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_433 = global::Tavily.ApiError.FromJson(__content_433, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_433 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::Tavily.ApiError? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::Tavily.ApiError.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Tavily.ExtractResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Tavily.AutoSDKHttpResponse<global::Tavily.ExtractResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Tavily.ExtractResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Tavily.ExtractResponse> ExtractAsync(
            ...
            global::Tavily.ExtractRequestExtractDepth? extractDepth = default,
            bool? includeImages = default,
            bool? includeFavicon = default,
            global::Tavily.ExtractRequestFormat? format = default,
            float? timeout = default,
            bool? includeUsage = default,
            global::Tavily.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Tavily.ExtractRequest
            {
                Urls = urls,
                Query = query,
