...
namespace Tavily
{
    ...
    public sealed partial class GetResearchResponseDiscriminator
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Tavily.JsonConverters.GetResearchResponseDiscriminatorStatusJsonConverter))]
        public global::Tavily.GetResearchResponseDiscriminatorStatus? Status { get; set; }
