...
namespace Tavily
{
    public partial class TavilyClient
    {
        ...
        /// print(response)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Tavily.AutoSDKHttpResponse<global::Tavily.CreateMapResponse>> CreateMapAsResponseAsync(
                ...
                else
                {
                    await global::Tavily.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 432)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 433)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse7>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Tavily.ApiException<global::Tavily.CreateMapResponse8>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Tavily.CreateMapResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Tavily.AutoSDKHttpResponse<global::Tavily.CreateMapResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Tavily.CreateMapResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
