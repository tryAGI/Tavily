...
namespace Tavily
{
    public partial class TavilyClient
    {
        ...
        private static readonly global::Tavily.EndPointSecurityRequirement s_MapSecurityRequirement0 =
        ...
        private static readonly global::Tavily.EndPointSecurityRequirement[] s_MapSecurityRequirements =
            new global::Tavily.EndPointSecurityRequirement[]
            {                s_MapSecurityRequirement0,
            };
        partial void PrepareMapArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tavily.MapRequest request);
        partial void PrepareMapRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tavily.MapRequest request);
        partial void ProcessMapResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMapResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// print(response)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Tavily.MapResponse> MapAsync(

            global::Tavily.MapRequest request,
            global::Tavily.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MapAsResponseAsync(
        ...
        /// print(response)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Tavily.AutoSDKHttpResponse<global::Tavily.MapResponse>> MapAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Tavily.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MapSecurityRequirements,
                operationName: "MapAsync");
                    ...
                    await global::Tavily.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Tavily.MapResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Tavily.AutoSDKHttpResponse<global::Tavily.MapResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Tavily.MapResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Tavily.MapResponse> MapAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Tavily.MapRequest
            {
                Url = url,
